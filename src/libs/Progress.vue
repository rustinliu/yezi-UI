<template>
    <div class="yezi-progress" ref="progressRef" @mousedown="onMouseDown($event)" @mouseenter="showIcon">
        <div class="yezi-progress-wrap">
            <div class="yezi-progress-bar" :style="barStyle"></div>
        </div>
    </div>
</template>
